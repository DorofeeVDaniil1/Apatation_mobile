...
''';
const String locate =
    """Общественный транспорт – автобус маршрута №10 или №20 (конечный пункт маршрута автобуса обязательно – РМЗ)
Остановка – Управление АНХК""";
const List<String> note1 = [
  "Что запрещено при входе (выходе) на территорию АО «АНХК»?",
  """Запрещено:
